(function () {
	...
	if (input.action == 'referencevalue' && input.filterData != '') {
		...
		po_item.addEncodedQuery(
			'u_po=' +
				input.filterData +
				'^u_po.u_budget_holder=' +
				input.budget_holder +
				'^u_po.u_active=true^ORDERBYu_master_item',

			// u_po=773c346f970d3a10f86b34b71153afd9^u_po.u_ist_budget_holder=81e939f4470136902cfb894c736d43bf
		);

		po_item.query();
		console.log('po_item Count ' + po_item.getEncodedQuery());
		while (po_item.next()) {
